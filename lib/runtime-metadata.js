...
function createRuntimeMetadata(options = {}) {
  ...
  function version() {
    return {
      ...
      architecture: ["Vanilla JS", "Node.js HTTP", "SQLite", "FTS5 Trigram + LIKE 回退", "UTF-8 / UTF-16 来源锚点", "实体线索档案", "内容寻址影像与声音", "人工确认转写", "事件级口述史", "共忆信笺加密往返", "设备内确定性镜片", "锁馆写入门禁", "结构恢复验真", "证据锚点", "迁移账本", "可校验修订链"],
      productFlow: ["记录或从文档逐段收件", "人工确认入馆", "AI 整理", "照片与声音归档", "可解释线索检索与讲解", "主题策展", "受限策展提案与逐项决定", "共忆见证", "设备内可解释镜片", "记忆回访", "时光胶囊与加密分享", "记忆考古", "口述史回答与时间来源", "历史恢复", "锁馆与结构验真", "安全导出"],
      v7: {
