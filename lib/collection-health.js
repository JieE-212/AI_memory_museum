...
const ISSUE_MESSAGES = Object.freeze({
  DATABASE_CURATOR_AGENT_STRUCTURE: "确定性策展工作流的运行、步骤、提案或人工决定结构需要核对。",
  ...
  CURATOR_AGENT_RUN_INTERRUPTED: "一项策展工作流运行被中断，可以人工决定是否重新开始。",
  CURATOR_AGENT_RUN_NEEDS_REVIEW: "一项策展工作流提案的来源已变化，需要人工复核。",
