...
const RESERVED_ARCHIVE_PREFIXES = Object.freeze(["media/", "exhibitions/", "revisits/", "entities/", "capsules/", "revisions/", "timeline/", VOICE_ARCHIVE_PREFIX]);
const REDACTED_COLLECTION_KEYS = new Set([
  ...
  "timeCalibrations", "version", "voices"
]);
const COLLECTION_ROOT_KEYS = new Set([
  ...
  "revisions", "revisits", "schemaVersion", "timeCalibrations", "version", "voices"
]);
