...
- 锁馆与结构恢复演练：在正文前阻止新的写请求，并以只读结构验真核对完整归档；两者都不冒充磁盘静态加密或灾难恢复证明。
...
V14.0.0 / schema 19 已于 2026-07-20 完成双远端发布与 Vercel 生产核验；CloudBase Run 国内入口已完成桌面公网首页和四 API 验收，手机 Wi-Fi 与蜂窝网络入口可达也已由用户真机确认，因此作为国内主入口与最终简历入口，Vercel 保留为全球备用。缩零冷启动仍待单独观察。V10.0.0 / schema 14 保留为 2026-07-19 的历史发布基线。更多说明见 [产品说明](./项目文档/产品说明.md)、[技术设计](./项目文档/技术设计.md) 和 [V5–V10 扩展路线](./项目文档/V5-V10扩展路线.md)。部署步骤见 [DEPLOYMENT.md](./DEPLOYMENT.md)。
