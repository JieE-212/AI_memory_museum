...
assert("review session package remains meeting only", sessionPackage.includes("2.0.15 / phase30-human-review-session-package") && sessionPackage.includes("meetingOnly=true"));
