...
const intentScript = html.indexOf('/assets/revisit-intents.js?v=7.3.0');
const revisitScript = html.indexOf('/assets/revisits.js?v=7.3.0');
const appScript = html.indexOf('/assets/app.js?v=7.3.0');
ok(intentScript > 0 && intentScript < revisitScript && revisitScript < appScript, "资源按意愿模块、回访控制器、主应用顺序加载");
equal((html.match(/\/revisit-intents\.css\?v=7\.3\.0/g) || []).length, 1, "回访意愿样式只加载一次");
