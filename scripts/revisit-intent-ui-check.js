...
const intentScript = html.indexOf('/assets/revisit-intents.js');
const revisitScript = html.indexOf('/assets/revisits.js');
...
equal((html.match(/\/revisit-intents\.css(?:\?[^"']*)?/g) || []).length, 1, "回访意愿样式只加载一次");
