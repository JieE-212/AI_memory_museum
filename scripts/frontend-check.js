...
const checks = [
  ...
  ["V16 多视角资源按 UI-host-app 顺序接入当前版本", html.includes(`/multi-perspective.css?v=${pkg.version}`) && html.indexOf(`/assets/multi-perspective.js?v=${pkg.version}`) < html.indexOf(`/assets/multi-perspective-host.js?v=${pkg.version}`) && html.indexOf(`/assets/multi-perspective-host.js?v=${pkg.version}`) < html.indexOf(`/assets/app.js?v=${pkg.version}`) && app.includes("TimeIsleMultiPerspectiveHost?.createController")],
