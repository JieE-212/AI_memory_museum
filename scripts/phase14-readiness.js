...
assert("server reports phase 14", server.includes("const PHASE = 14") && server.includes("工程模块化和服务边界重构"));
...
assert("whitepaper documents phase 14", whitepaper.includes("第十四阶段") && whitepaper.includes("工程模块"));
