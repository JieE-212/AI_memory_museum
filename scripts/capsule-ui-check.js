...
ok(html.indexOf('/assets/capsule-crypto.js?v=7.1.0') < html.indexOf('/assets/capsules.js?v=7.1.0'), "加密模块先于胶囊控制器加载");
ok(html.indexOf('/assets/capsules.js?v=7.1.0') < html.indexOf('/assets/app.js'), "胶囊控制器先于主应用加载");
