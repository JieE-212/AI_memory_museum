...
ok(
  html.indexOf('/assets/capsule-crypto.js?v=9.0.0') < html.indexOf('/assets/share-privacy.js?v=9.0.0') &&
  html.indexOf('/assets/share-privacy.js?v=9.0.0') < html.indexOf('/assets/capsules.js?v=9.0.0'),
  "资源按加密模块、隐私编辑台、胶囊控制器顺序加载"
);
ok(html.indexOf('/assets/capsules.js?v=9.0.0') < html.indexOf('/assets/app.js'), "胶囊控制器先于主应用加载");
equal((html.match(/\/share-privacy\.css\?v=9\.0\.0/g) || []).length, 1, "分享隐私样式只加载一次");
