...
assert("frontend confirms phase 15 export quality", app.includes("confirmExportPackageRisk") && app.includes("专题资产还有") && app.includes("assetQuality.totalIssues"));
...
assert("frontend reduces phase 15 asset workbench noise", app.includes("asset-advanced-tools") && app.includes("asset-recovery-note") && app.includes("快照对比不会直接覆盖当前资产"));
...
assert("README documents phase 15", readme.includes("第十五阶段") && readme.includes("savedExhibitions"));
assert("whitepaper documents phase 15", whitepaper.includes("第十五阶段") && whitepaper.includes("专题资产"));
assert("plan documents phase 15", plan.includes("第十五阶段") && plan.includes("savedExhibitions"));
